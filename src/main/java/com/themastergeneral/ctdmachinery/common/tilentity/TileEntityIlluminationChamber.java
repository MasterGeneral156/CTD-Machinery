...
import com.themastergeneral.ctdmachinery.common.blocks.IlluminationChamberBlock;
import com.themastergeneral.ctdmachinery.common.config.Config;
import com.themastergeneral.ctdmachinery.common.handlers.IlluminationChamberRecipes;
import com.themastergeneral.ctdmachinery.server.container.ContainerIlluminationChamber;

public class TileEntityIlluminationChamber extends TileEntity implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityIlluminationChamber.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                IlluminationChamberBlock.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    {
        return Config.InitialIlluminationTime;
    }
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = IlluminationChamberRecipes.instance().getSmeltingResult((ItemStack)this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = IlluminationChamberRecipes.instance().getSmeltingResult(itemstack);
    ...
    {
        return new ContainerIlluminationChamber(playerInventory, this);
    }
